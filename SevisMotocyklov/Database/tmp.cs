...
namespace SevisMotocyklov.Database.dao_sqls
{
    class tmp
    {
        ...
        public static Collection<Objednavka> SelectFull(string param)
        {
            ...
            SqlCommand command = db.CreateCommand(SQL_SELECT_FULL);
        ...
        public static Collection<Objednavka> SelectFull2()
        {
            ...
            SqlCommand command = db.CreateCommand(SQL_SELECT_FULL2);
            //command.Parameters.AddWithValue("@param", param);
            SqlDataReader reader = db.Select(command);
        ...
        public static void MakeOrder(int zakaznik, int motocykel, int zamestnanec, int diel, int praca, int hodiny, DatabaseClass pDb = null)
        {
            DatabaseClass db;
            if (pDb == null)
            {
        ...
        public static void AddToOrder(int diel, int praca, int hodiny, int objednavka, int zamestnanec, DatabaseClass pDb = null)
        {
            DatabaseClass db;
            if (pDb == null)
            {
        ...
        public static Objednavka Select(int id, DatabaseClass pDb = null)
        {
            DatabaseClass db;
            if (pDb == null)
            {
        ...
        private static Collection<Objednavka> ReadFull(SqlDataReader reader)
        {
            ...
            while (reader.Read())
            {
                ...
                //objednavka.ID, zakaznik.meno, zakaznik.priezvisko, zamestnanec.meno, zamestnanec.priezvisko, motocykel.vyrobca, motocykel.model, count(oprava.ID) as pocet_prav, sum(oprava.cena) as celkova_cena
